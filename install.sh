...
sh $ROOT/_copy.sh $ROOT/configs/claude/CLAUDE.md ~/.claude/CLAUDE.md
sh $ROOT/_copy.sh $ROOT/configs/claude/plugins/claude-hud/config.json ~/.claude/plugins/claude-hud/config.json
