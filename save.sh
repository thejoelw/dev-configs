...
sh $ROOT/_copy.sh ~/.claude/CLAUDE.md $ROOT/configs/claude/CLAUDE.md
sh $ROOT/_copy.sh ~/.claude/plugins/claude-hud/config.json $ROOT/configs/claude/plugins/claude-hud/config.json
